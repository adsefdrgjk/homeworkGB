...
git rm
Команда git rm используется в Git для удаления файлов
git mv
...
git tag
Команда git tag используется для задания постоянной метки
...
git fetch
Команда git fetch связывается с удалённым репозиторием и забирает
